...
typedef int_fast32_t ngp_time_t; // clock cycle count
...
class T6W28_Apu
{
   public:
      ...
      // Write to data port
      void write_data_left( ngp_time_t, int );
      void write_data_right( ngp_time_t, int );
   ...
   private:
      ...
      ngp_time_t  last_time;
      int         latch_left, latch_right;
      T6W28_Noise   noise;

      void run_until( ngp_time_t );
};
